...
Field 01 explores whether particles and black-hole horizons can be described as phase-structural regimes of a field: open transport, closed waves, scalar modulus / VEV-profile layer with a normal-retention interpretation, memory, and boundary recording.
...
1. build a minimal mathematical formalization of phase, circulation, scalar modulus / VEV-profile language with a labelled normal-retention interpretation, and memory;
