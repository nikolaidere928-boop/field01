...
This paper continues the work on the elementary particle as a closed wave of Field 01. In the first paper, a local particle was described as a closed phase node with a normal degree of freedom, mass, and memory. Here we consider the limiting case: what happens when such a local structure reaches a black-hole horizon.
...
In Field 01 an elementary particle is a local node of memory. It retains a phase structure through closed circulation and a normal degree of freedom. Schematically,
\begin{equation}
\text{particle} = \text{local memory} + \normal.
\end{equation}

The black-hole horizon is another regime of memory. It does not retain the local normal degree of freedom of an individual particle. Instead, it translates many local phase structures into a global surface record:
\begin{equation}
...
\begin{equation}
\text{collapse to point} \quad \longrightarrow \quad \text{collapse of the normal degree of freedom}.
\end{equation}

If the normal degree of freedom is suppressed,
\begin{equation}
\normal \rightarrow 0,
\end{equation}
...
A closed wave has phase circulation and a local normal degree of freedom. Near the horizon the radial direction becomes limiting for the external description. In the language of Field 01, the normal degree of freedom is suppressed and tangential or surface degrees of freedom become dominant.
...
Field 01 proposes to interpret a black hole as a limiting regime of the field in which local phase structures lose their normal degree of freedom and become surface records. In this description the horizon is not an entrance to a point singularity, but an archive of phase information.
