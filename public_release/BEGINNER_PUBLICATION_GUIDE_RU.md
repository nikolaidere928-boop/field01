...
```text
Field 01 is an independent toy-level formalization project exploring phase circulation, closed nodes, normal retention, memory classes, and boundary recording. It is not a completed physical theory; the project seeks criticism and comparison with established physics.
```
