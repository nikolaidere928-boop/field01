...
\begin{center}
\textit{Working version v0.1 --- English formalization draft}
\end{center}
...
\section{Normal Retention And Mass Proxy}

Field 01 interprets a massive local node as more than a phase winding. It also requires normal retention, represented in the first toy model by a scalar radial profile
\begin{equation}
N=N(r).
\end{equation}
...
\section{Gauge-Like Compensation}

The unscreened winding retains long-range phase mismatch. To compensate it, introduce a connection-like field $A_\mu$ and the covariant phase derivative
\begin{equation}
...
The book-level concept of memory is formalized as an equivalence class of preserved phase-normal-gauge data:
\begin{equation}
\memory_{\bulk}
