...
\begin{abstract}
This paper formulates a first core element of Field 01: an elementary particle is interpreted not as a material point, but as a stable closed wave configuration of a field. Two regimes of the field---fixation $0$ and direction $1$---form a rhythm from which phase circulation, a normal degree of freedom, local depth, mass, and memory can be described. A photon is interpreted as an open transport of phase $1$, whereas a massive elementary particle appears only when the circulation closes and a normal degree of freedom is retained. This approach replaces the point-like core by a dynamical core and thereby avoids an internal point singularity in the model description of an elementary particle. A black-hole horizon appears as a limiting regime of the same logic: suppression of the normal degree of freedom and transition of phase memory into a surface record.
\end{abstract}

\textbf{Keywords:} Field 01; closed wave; elementary particle; phase circulation; normal degree of freedom; mass; memory; quantum field theory; horizon; holography.
...
\item \textbf{Interpretation proposed by Field 01}: a particle is described as a stable field regime, a photon as open phase transport, and a massive particle as a closed node with a normal degree of freedom.
\item \textbf{Open hypothesis}: the normal degree of freedom, memory, phase tension, horizon surface recording, and the non-literal evaporation picture used in Field 01 require further mathematical formalization.
\end{enumerate}
...
\begin{quote}
An elementary particle can be interpreted as a stable closed phase configuration of Field 01, in which the phase circulation is self-consistent and a local normal degree of freedom is retained.
\end{quote}
...
In the language of Field 01 this relation can be read as a link between energy and the frequency of phase rhythm. A photon is interpreted as an open transport of the regime $1$: phase is carried, but no local normal degree of freedom is retained.
...
This is not intended to replace quantum electrodynamics. It is a model-specific interpretation of why the photon has no rest mass: in Field 01, mass is associated with the retention of a closed phase structure and its normal degree of freedom, while the photon remains an open propagating mode.
...
A closed phase circulation introduces an additional feature absent in the open photon mode: a local normal degree of freedom. We denote it by
\begin{equation}
\normal.
\end{equation}

The normal degree of freedom is not a material rod inside the particle. It is a way of describing local depth, or the direction in which the closed phase configuration can hold itself as a localized node.
...
In the model, mass is interpreted as the energy cost of maintaining a closed phase configuration and its normal degree of freedom. A schematic expression is
\begin{equation}
...
\memory = \memory[\phase,\normal,\contour]
\end{equation}
denote the information retained by a closed configuration. This notation is schematic. It means that memory is carried not by a material shape alone, but by phase relations, circulation, and the stability of the normal degree of freedom.
...
\item strong interaction may be associated with tight coordination of normal degrees of freedom and local phase locking;
...
At the current stage, however, expressions such as phase tension or normal-retention energy are only working terms. They should not be confused with an already defined tensorial theory.

\section{Limit: Vanishing Normal and Horizon}

The same logic that distinguishes an open photon mode from a closed massive particle also suggests a limiting regime near a horizon. If the normal degree of freedom is suppressed,
\begin{equation}
\normal \rightarrow 0,
\end{equation}
...
\end{equation}
with the normal degree of freedom suppressed:
\begin{equation}
\normal \rightarrow 0.
\end{equation}
...
\item the photon can be interpreted as open phase transport without a normal degree of freedom;
\item mass can be associated with the energetic cost of maintaining a closed configuration;
\item a horizon can be interpreted as a limiting surface where the normal degree of freedom is suppressed and phase memory becomes boundary record.
\end{itemize}
...
The central idea of this paper is simple: an elementary particle may be described as a closed wave of Field 01 rather than as a point-like object. The closure of phase circulation produces a localized node, the retention of a normal degree of freedom gives the node local depth, and the energy of maintaining this structure can be interpreted as mass.

A photon is then the limiting open case: it transports phase and energy, but does not retain a normal degree of freedom and therefore has no rest mass. A horizon is the opposite limiting case: the normal degree of freedom is suppressed and the phase memory of a bulk configuration is transferred into a boundary record.
